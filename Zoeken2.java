...
public class Zoeken2 extends Woordboom {
	...
	public static void Location(String L){
		...
		ArrayList<WNode> p2 = new ArrayList();
		p2.add(listp1.get(0));
...
public static void Check(ArrayList<WNode> p2, String L){
	int x=0;
	ArrayList<WNode> current = new ArrayList();
	while(x<p2.size()){
